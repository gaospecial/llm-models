...
#| eval: false
body = {
    "prompt_image": "https://dds-frontend.oss-accelerate.aliyuncs.com/static_files/playground/ivp/v2/left_17.jpeg",
    "infer_image": "https://dds-frontend.oss-accelerate.aliyuncs.com/static_files/playground/ivp/v2/right_17.jpeg",
    "prompts": [
        {
            "type": "rect",
            "is_positive": 1,
...
task = DetectionTask(
    image_url=image_url,
    prompts=[TextPrompt(text="plate"), TextPrompt(text="leaf"), TextPrompt(text="seedling")],
...
```{r}
knitr::include_graphics("example/results/detection-result-mask.png")
```
